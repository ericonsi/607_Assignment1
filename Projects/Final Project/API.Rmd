...
We scrape and then clean 17 pages of zipatlas data to compile a table of zip codes, population levels and poverty levels.  We also read a csv file, taken from the web, which contains information on zip code and broadband access.
