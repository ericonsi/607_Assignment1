...
This is the last step. We now have two clean data frames in long form. The only thing that remains is using the same steps to read in the other years and appending those dataframes to these.
